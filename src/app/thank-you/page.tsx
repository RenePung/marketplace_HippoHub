            ...
            <div>
                <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:py-32 xl:gap-x-24">
                    <div className="lg:col-start-2">
                        <p className="text-md font-medium text-green-500 underline">
                        ...
                        {order._isPaid ? (<p className="mt-2 text-base text-muted-foreground">
                            ...
                            your receipt and orders details to{" "}
                        ...
                        <p className="mt-2 text-base text-muted-foreground">
                            We appreciate your order, and we&apo;re 
                        ...
                        <div className="mt-16 text-sm font-medium">
                            <div className="text-muted-foreground">Order nr.
                        </div>
                            <div className="mt-2 text-gray-900">{order.id}
                        </div>
                                    ...
                                    <li key={product.id} className="flex space-x-6 py-6">
                                        ...
                                        <div className="flex-auto flex flex-col justify-between">
                                            <div className="space-y-1">
                                                <h3 className="text-violet-600">{product.name}</h3>
                        ...
                        <div className="space-y-6 border-t border-violet-200 pt-6 text-sm font-medium text-muted-foreground">
