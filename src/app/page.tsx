...
const perks = [
  ...
  },
  {
    name: "For The Planet",
    Icon: Leaf,
    description: "We've pledged 90% of sales to the preservation and restoration of the natural environment."
  },
]
      ...
      <div className="py-20 mx-auto text-center flex flex-col items-center max-w-3xl">
        <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
          ...
          <p className="mt-6 text-lg max-w-prose text-muted-foreground">
            Welcome to HippoHub. Every asset on our
          ...
          {perks.map((perk) => (
            ...
            className="text-center md:flex md:items-start md:text-left lg:block lg:text-center">
              ...
              <div className="mt-6 md:ml-4 md:mt-0 lg:ml-0 lg:mt-6">
                <h3 className="text-base font-medium text-violet-900">{perk.name}</h3>
                <p className="mt-3 text-sm test-muted-foreground">
                  {perk.description}
                </p>
              </div>
            </div>
