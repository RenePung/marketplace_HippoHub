"use client" // because we are using a hook
                        ...
                        <div className="mt-6 space-y-4">
                            <div className="flex items-center justify-between">
                                ...
                                <p className="text-sm font-medium text-gray-900">
                                    {isMounted ? (
                                        ...
                                        <Loader2 className="h-4 w-5 animate-spin text-muted-foreground" />
                                    )}
                                </p>
                            </div>
                            ...
                            <div className="flex items-center justify-between border-t border-gray-200 pt-4">
                                ...
                                <div className="text-sm font-medium text-gray-900">
                                    {isMounted ? formatPrice(fee) : <Loader2 className="h-4 w-5 animate-spin text-muted-foreground" />}
                                </div>
                            </div>

                            <div className="flex items-center justify-between border-t border-gray-200 pt-4">
                                <div className="text-base font-medium text-violet-600">Order Total:</div>
                                <div className="text-base font-medium text-violet-600">
                                {isMounted ? formatPrice(cartTotal + fee) : <Loader2 className="h-4 w-5 animate-spin text-muted-foreground" />}
                                </div>
                            </div>
                        </div>
