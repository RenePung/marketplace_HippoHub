...
const NavItem = ({isOpen, category, isAnyOpen, handleOpen}: NavItemProps) => {
    return (
        <div className="flex">
                                ...
                                <div className="col-span-4 col-start-1 grid grid-cols-3 gap-x-8">
                                    {category.featured.map((item) => (
                                        <div key={item.name} className="group relative text-base sm:text-sm">
                                            <div className="relative aspect-video overflow-hidden rounded-lg bg-violet-100 group-hover:opacity-75">
                                                <Image 
                                                src={item.imageSrc} 
